...
function getTwitterCard() {
  return [
    ...
    metadata.twitter.url ? { hid: 'twitter:url', name: 'twitter:url', content: metadata.twitter.url } : '',
    metadata.twitter.creator ? { hid: 'twitter:creator', name: 'twitter:creator', content: metadata.twitter.creator } : ''
  ]
}
