...
const checkStorage = () => {
  if (process.client) {
    const storage = localStorage.getItem('preview')
    if (storage === null) {
      display.value = true
    }
  }
...
<template>
  <transition>
    <div v-if="display" class="fixed z-50 top-5 left-5">
      <div class="rounded-md bg-gray-50 dark:bg-gray-700 p-4 w-96">
        <div class="flex">
