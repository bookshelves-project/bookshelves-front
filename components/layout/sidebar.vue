        ...
        <div class="flex items-center shrink-0 px-4">
          <nuxt-link to="/" class="inline-flex items-center w-auto h-8">
            <span class="inline-flex items-center" @click="closeSidebar">
              ...
              />
              <div class="mt-2 ml-3 text-2xl font-handlee">{{ $config.appName }}</div>
            </span>
          </nuxt-link>
        </div>
        <div class="flex-1 h-0 mt-5 overflow-y-auto">
          <nav class="px-2">
            <div class="space-y-1">
              ...
              >
                <span class="w-full px-2 py-4 font-semibold" @click="closeSidebar">Home</span>
              </nuxt-link>
              <nuxt-link
              ...
              <div class="mt-3 space-y-1" role="group" aria-labelledby="teams-headline">
                <div v-if="$auth.$state.loggedIn" class="space-y-2">
                  <nuxt-link
                    ...
                    role="menuitem"
                  >
                    <span class="flex items-center px-3 py-4" @click="closeSidebar">
                      <span class="w-2.5 h-2.5 mr-4 bg-primary-600 rounded-full" aria-hidden="true"></span>
