...
If you want to use <markdown-app-name></markdown-app-name> with OPDS, you can use <markdown-api-link endpoint="/features/opds/v1.2" self-refer></markdown-api-link> feed, check [OPDS & Catalog](/pages/opds-catalog-more) to know more about this.
